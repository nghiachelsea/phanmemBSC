...
if(!empty($_REQUEST['maTieuchi']) && !empty($_REQUEST['maTN_TTVT']) && !empty( $_REQUEST['maTN_TTDHTT']) && !empty($_REQUEST['tenTieuchi'])  && !empty( $_REQUEST['chitietTieuchi'])  && !empty( $_REQUEST['mucdiemtrucnTTVT']) && !empty( $_REQUEST['mucdiemtruttTTVT']) && !empty( $_REQUEST['mucdiemtrucnTTDHTT']) && !empty( $_REQUEST['mucdiemtruttTTDHTT'])  ){ 
    ...
    $sql = "INSERT INTO nguoidung(maTieuchi,maTN_TTVT,maTN_TTDHTT,tenTieuchi, chitietTieuchi, mucdiemtrucnTTVT, mucdiemtruttTTVT, mucdiemtrucnTTDHTT, mucdiemtruttTTDHTT) VALUES ('$maTieuchi','$maTN_TTVT','$maTN_TTDHTT','$tenTieuchi', '$chitietTieuchi', '$mucdiemtrucnTTVT', '$mucdiemtruttTTVT', '$mucdiemtrucnTTDHTT','$mucdiemtruttTTDHTT')";
